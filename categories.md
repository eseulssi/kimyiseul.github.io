...
![gif](wwcmain.gif){: width="750px" height="400px"}<br/>  
<p class = "center-text">&#128071; my role &#128071;</p> 

![gif](cateChat.gif){: width="750px" height="400px"}<br/> 
...
![gif](cateChatting.gif){: width="750px" height="400px"}<br/>
...
![gif](pay.gif){: width="750px" height="400px"}<br/>
...
![gif](potion.gif){: width="750px" height="400px"}<br/>
<p class = "center-text">&#128071; my role &#128071;</p>  

![gif](qna.gif){: width="750px" height="400px"}   
...
![gif](cart.gif){: width="750px" height="400px"}<br/>
